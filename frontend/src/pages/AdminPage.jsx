            ...
            <div style={{ 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                ...
                <div style={{
                  ...
                  <p style={{ marginBottom: '20px', opacity: 0.9, fontSize: '0.95rem' }}>
                    Télécharge un fichier JSON avec tous les utilisateurs et leurs réponses.
                  </p>
                  <button
                    onClick={async () => {
                      try {
                ...
                <div style={{
                  ...
                  <p style={{ marginBottom: '20px', opacity: 0.9, fontSize: '0.95rem' }}>
                    ⚠️ Attention : remplacera TOUTES les données actuelles !
                  </p>
                  <input
                    type="file"
                    accept=".json"
                    onChange={async (e) => {
                      ...
                      try {
                        ...
                        setMessage('❌ Erreur : fichier invalide');
                      }
